...
namespace Falcor.Server.Routing
{
    ...
    {
        public FalcorRouterConfiguration(string path, Func<FalcorRouterConfiguration, FalcorRouter> routerFactory,
            IServiceProvider serviceProvider = null)
        {
            ...
            if (serviceProvider != null)
            {
                ...
                ResponseSerializer = ServiceProvider.GetService(typeof (IResponseSerializer)) as IResponseSerializer ??
                                     ResponseSerializer;
            }
